...
function Counter({ value, suffix }: { value: number; suffix: string }) {
  ...
  return (
    <span ref={ref} className="font-cairo text-4xl font-black text-brand-700 md:text-5xl">
...
const STATS = [
  { value: 120, suffix: " ألف+", label: "إعلان منشور" },
  { value: 48, suffix: " ألف+", label: "مستخدم نشط" },
  { value: 96, suffix: "%", label: "رضا عمليات التفاوض" },
  { value: 0, suffix: " د.ل", label: "عمولة على البيع" },
];
